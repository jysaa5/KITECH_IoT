...
//BoardListView: 게시물 리스트에 관련된 데이터를 표현하는 도메인 클래스
public class BoardListView {
	...
	public BoardListView(List<BoardEditVo> list, int totalArticleCount, int currentPageNo, int startRow, int countPerPage) {
		super();
		this.list = list;
