...
//BoardWriteRequest: 게시글을 작성시 요청 데이터를 보관하여 전달하는 도메인 클래스
public class BoardWriteRequest {
	...
	//전체 필드를 받는 생성자
	public BoardWriteRequest(int idx, String writer, String title, String content, String gpw, MultipartFile photo, Date regdate) {
		super();
		this.idx = idx;
		this.writer = writer;
		this.title = title;
	...
	public String toString() {
		...
		return "BoardWriteRequest [idx=" + idx + ", writer=" + writer + ", title=" + title + ", content=" + content + ", gpw=" + gpw + ", photo=" + photo + ", regdate=" + regdate + "]";
