...
//	int cnt; //카운터용, 추가 인덱스 
	...
	public static PhoneBookManager2 getInstance() { //인스턴스를 생성하지 않아도 사용가능하도록 static을 씀.
		if(m==null) {
	...
	private static PhoneBookManager2 m = new PhoneBookManager2(); //외부에서 참조변수값을 못 바꾸도록 private을 씀.
	
	//private으로 외부에서 인스턴스 생성을 막음. 
	private PhoneBookManager2(){ //생성자에서 사이즈를 받아서 인스턴스를 생성할 수 있다. 
