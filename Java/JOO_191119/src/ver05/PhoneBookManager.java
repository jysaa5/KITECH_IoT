...
public class PhoneBookManager {
	...
	private static PhoneBookManager m = new PhoneBookManager(); //외부에서 참조변수값을 못 바꾸도록 private을 씀.
	
	public static PhoneBookManager getInstance() { //인스턴스를 생성하지 않아도 사용가능하도록 static을 씀.
		if(m==null) {
	...
	private PhoneBookManager(){ //생성자에서 사이즈를 받아서 인스턴스를 생성할 수 있다. 
