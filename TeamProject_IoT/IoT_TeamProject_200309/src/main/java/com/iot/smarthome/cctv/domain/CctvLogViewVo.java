...
public class CctvLogViewVo {
	...
	//<생성자>//
	//기본 생성자
	public CctvLogViewVo() {
		super();
	}

	//생성자
	public CctvLogViewVo(int cctvLogIdx, String cctvLogFile) {
		super();
	...
	public String toString() {
		return "CctvLogViewVo [cctvLogIdx=" + cctvLogIdx + ", cctvLogFile=" + cctvLogFile + "]";
	}
