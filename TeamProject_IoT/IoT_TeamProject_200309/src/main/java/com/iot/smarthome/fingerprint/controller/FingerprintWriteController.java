...
@Controller
@RequestMapping("/fingerprint/write")
public class FingerprintWriteController {
...
//	}//wrtieForm 메서드 끝
	...
	public String write(CctvWriteRequestVo write, HttpServletRequest request, Model model) {
